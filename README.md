...
- [x] Add DKMS or an Event to recompile module after kernel upgrades #113	(Added in this repo by Leeroy - Dont forget to name the directory acer_kerboard-1.0 or change in dkms)
- [ ] Custom Fans speed
